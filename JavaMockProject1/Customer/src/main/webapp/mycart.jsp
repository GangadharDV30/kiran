...
<body>
	<nav>
<a href="./main.jsp"><img src="Publicis_Sapient_Logo.jpg" alt="add crt Logo" class="logo"></a>
 <ul> <li><a class="a1">  ${fn: toUpperCase(sessionScope.customer.customerName)} !</a> </li> <li><a class="a2" href="./mycart"> Cart</a> </li><li><a class="a3"> Log Out</a> </li>
</ul>
</nav>
